            ...
            <div className="container p-3">
                <div className="row">
                    <div className="col">
                        ...
                        <p>This course develops the leadership and project management skills necessary to successfully lead and deliver software projects. Students learn to navigate project lifecycles, manage budgets and timelines, and optimize resource allocation, ensuring the efficient planning, execution, and deployment of high-quality software solutions that meet client needs and exceed expectations.</p>
                    ...
                    <ul className='list'>
                        ...
                        <li>Back-End Development Basics</li>
